package com.company.springtest.config;
...
public class DataConfig {
    ...
    private Properties getHibernateProperties() {
        ...
        properties.put(PROP_HIBERNATE_CONNECTION_USERNAME, env.getRequiredProperty(PROP_DATABASE_USERNAME));
        properties.put(PROP_HIBERNATE_CONNECTION_PASSWORD,  env.getRequiredProperty(PROP_DATABASE_PASSWORD));
